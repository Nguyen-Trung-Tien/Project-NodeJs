...
var initWebRouters = function initWebRouters(app) {
  ...
  router.get("/delete-crud", _homeController["default"].deleteUserById);
  ...
  router.post("/api/save-info-doctors", _doctorController["default"].postInfoDoctor);
  ...
  router.get("/api/get-extra-info-doctor-by-id", _doctorController["default"].getExtraDoctorById);
